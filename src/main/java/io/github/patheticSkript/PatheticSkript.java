...
import io.github.patheticSkript.pathfinder.expressions.ExprPathfind;
...
public final class PatheticSkript extends JavaPlugin {

    private static PatheticSkript instance;
    public Logger logger = super.getLogger();
    ...
    public static PatheticSkript getInstance()  {
        return instance;
    }
}
